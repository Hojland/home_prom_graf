...
if __name__ == "__main__":
    b = BME280()
    while True:
        temperature, pressure, humidity, altitude = b.all()
...
#
#    while True:
#        cpu_temp = b.get_temperature()
#        cpu_temps.append(cpu_temp)
#
#        if len(cpu_temps) > smooth_size:
#            cpu_temps = cpu_temps[1:]
#
#        smoothed_temp = sum(cpu_temps) / float(len(cpu_temps))
#
#        print("Compensated temperature: {:05.2f} *C".format(smoothed_temp))
#
#        microbit.sleep(100)